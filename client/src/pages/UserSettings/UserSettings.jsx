    ...
    <div className="container">
       {isSuccessEmail ? (
            <div className="toast-mess-container">
              <button
                ref={toast}
                className={`alert-toast-message success`}
              >
                {isSuccessEmail}
              </button>
            </div>
      ...
      {isUpdate ? (
        <div className="modal__change-email">
            ...
            <div className="toast-mess-container">
              <button
                ref={toast}
                className={`alert-toast-message err`}
              >
                {isErrEmail }
              </button>
            </div>
        ...
        <div className="settings">
          {isErr || isSuccess ? (
            <div className="toast-mess-container">
              <button
                ref={toast}
                className={`alert-toast-message ${isErr ? "err" : "success"}`}
              >
              ...
              <div className="l-4">
                <ul className="settings__navbar">
                  <li className="settings__navbar-item">
                    <span className="settings__navbar-text">Account</span>
                  </li>
                </ul>
              </div>
              <div className="l-8">
                  ...
                  <div className="settings__content">
                    ...
                    <div className="settings__account">
                      ...
                      <div className="settings__flex">
                        ...
                        <div className="settings__flex-item">
                          <div>
                            <label className="settings__name">Pi Network Acount</label>
                        ...
                        <div className="settings__flex-item">
                          <label className="settings__name">BIRTHDAY</label>
                      ...
                      <div className="settings__form">
                        <p className="settings__password">Change Password</p>
