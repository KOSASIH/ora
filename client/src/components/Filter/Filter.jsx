...
const Filter = ({posts}) => {
  ...
  const fitterList = [
    ...
    },
    {
      ...
      path: "/?sort=top",
      icon: (
        <svg fill="#718096" width="13" height="15" viewBox="0 0 13 15" xmlns="http://www.w3.org/2000/svg"><path _ngcontent-serverapp-c41="" d="M7.85156 2.5H12.5V10.8203H6.67969L6.32812 9.17969H1.67969V15H0V0.820312H7.5L7.85156 2.5Z" className="cls-1"></path></svg>
      ),
    },
  ];
  const listTab = [
